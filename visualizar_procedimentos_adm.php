            ...
            <tbody>
                <?php while ($row = $result->fetch(PDO::FETCH_ASSOC)) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="editar_procedimento_adm.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Editar</a>
                            <a href="excluir_procedimento_adm.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Tem certeza que deseja excluir este procedimento?');">Excluir</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
