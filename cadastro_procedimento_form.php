...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        echo '<script>alert("Procedimento cadastrado com sucesso!"); window.location = "visualizar_procedimentos_adm.php";</script>';
    } else {
        echo '<script>alert("Erro ao cadastrar procedimento. Tente novamente."); window.location = "cadastrar_procedimento_form.php";</script>';
    }
}
?>
...
<h1 class="text-center">Cadastrar Procedimento</h1>
    <div class="container mt-5">
        ...
        <form action="cadastro_procedimento_form.php" method="post">
            <div class="mb-3">
