...
if (isset($_GET["id"])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($stmt->execute()) {
            echo '<script>alert("Procedimento atualizado com sucesso!"); window.location = "visualizar_procedimentos.php";</script>';
        } else {
            echo '<script>alert("Erro ao atualizar procedimento. Tente novamente."); window.location = "editar_procedimento.php?id=' . $id . '";</script>';
        }
    }
} else {
...
<h1 class="text-center">Editar Procedimento</h1>
    <div class="container mt-5">
        ...
        <form action="editar_procedimento.php?id=<?php echo htmlspecialchars($id); ?>" method="post">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <a href="visualizar_procedimentos.php" class="btn btn-light">Voltar</a>
            </div>
        </form>
    </div>
